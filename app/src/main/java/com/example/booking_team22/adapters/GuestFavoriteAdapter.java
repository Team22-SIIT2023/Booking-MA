...
public class GuestFavoriteAdapter extends ArrayAdapter<Accomodation> {
    private ArrayList<Accomodation> aAccomodation;

    public GuestFavoriteAdapter(FragmentActivity context, ArrayList<Accomodation> products){
        super(context, R.layout.guest_favorite_card, products);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.guest_favorite_card,
                    parent, false);
        }
        LinearLayout productCard = convertView.findViewById(R.id.product_card_item);
        ImageView imageView = convertView.findViewById(R.id.product_image);
        ImageView imageView2 = convertView.findViewById(R.id.favourite_icons);
