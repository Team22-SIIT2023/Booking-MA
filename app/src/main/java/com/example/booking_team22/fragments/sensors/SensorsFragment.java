package com.example.booking_team22.fragments.sensors;
...
import com.example.booking_team22.databinding.FragmentSensorsBinding;
...
public class SensorsFragment extends Fragment implements SensorEventListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvLightSensor = fragmentSensorsBinding.tvLightSensor;
    }
    ...
    public void onResume() {
        ...
        if (lightSensor == null) {
            Toast.makeText(requireContext(), "No light sensor found in device.", Toast.LENGTH_SHORT).show();
        } else {
            // registering our light sensor with sensor manager
            sensorManager.registerListener(this,
                    lightSensor,
                    SensorManager.SENSOR_DELAY_NORMAL);
        }
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        if (sensorEvent.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            tvLightSensor.setText("Light Sensor: " + lightValue);

            // Dodajte svoju logiku za reakciju na promene osvetljenosti
            if (lightValue < 100) {
                // Osvetljenost je ispod praga
                Log.d("Light Sensor", "Low light detected");
            } else {
                // Osvetljenost je iznad praga
                Log.d("Light Sensor", "High light detected");
            }
        }
    }
